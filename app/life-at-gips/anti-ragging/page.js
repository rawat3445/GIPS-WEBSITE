...
export default function AntiRagging() {
  ...
  const preventiveMeasures = [
    {
      ...
      description:
        "Mandatory sessions for all new students about anti-ragging policies",
    },
    {
      icon: Eye,
      title: "CCTV Surveillance",
      description:
        "24/7 monitoring of all campus areas including hostels and common spaces",
    },
    {
      icon: Bell,
    ...
    },
    {
      ...
      description:
        "Surprise checks in hostels and campus areas by committee members",
    },
    {
      icon: FileText,
  ...
  const reportingChannels = [
    ...
    },
    {
      icon: Mail,
      title: "Email",
      value: "antiragging@gips.edu.in",
      color: "text-blue-600",
    },
    {
      icon: Mail,
      title: "UGC Helpline",
      value: "helpline@antiragging.in",
  ...
  const steps = [
    {
      ...
      description:
        "Contact helpline, email, or approach committee members directly",
    },
    {
      step: 2,
    ...
    },
    {
      ...
      title: "Action Taken",
      description:
        "Strict disciplinary action against guilty parties within 24 hours",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "You should still report it. Witnesses play a crucial role in eliminating ragging. Your report will be kept confidential.",
    },
    {
      question: "Will my identity be revealed if I report?",
      answer:
        "No. The committee ensures complete confidentiality and your identity will be protected throughout the investigation.",
    },
    {
      question: "Can ragging happen online or on social media?",
      answer:
        "Yes. Cyber-ragging through social media, messages, or online platforms is equally punishable under anti-ragging laws.",
    },
    {
      question: "What is the UGC Anti-Ragging Helpline?",
      answer:
        "UGC has a 24/7 toll-free helpline (1800-180-5522) where students can report ragging incidents anonymously.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 mt-0">
      {/* Hero Section */}
      <div className="bg-linear-to-rfrom-red-600 via-orange-600 to-red-700 text-white px-8 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className=" bg-opacity-20 backdrop-blur-sm rounded-xl p-8 max-w-4xl mx-auto">
            <p className="text-2xl text-center leading-relaxed">
              <strong>ZERO TOLERANCE</strong> - GIPS is committed to maintaining
              a safe, respectful, and ragging-free environment for all students
            </p>
          </div>
            ...
            <div className="space-y-4 text-gray-700">
                ...
                <ul className="space-y-2">
                  {reportingChannels.map((channel, idx) => (
                    <li key={idx} className="flex items-center">
                      <channel.icon
                        className={`w-5 h-5 ${channel.color} mr-3`}
                      />
                      <span>
                        <strong>{channel.title}:</strong> {channel.value}
                      </span>
                    </li>
                  ))}
                </ul>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4">
                ...
                <p className="text-sm mt-0">
                  Register your complaint on the UGC-approved portal for
                  immediate action
                </p>
              </div>
              <button
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-red-600">
          ...
          <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
            <p>
              GIPS follows a strict <strong>zero-tolerance policy</strong>{" "}
              towards ragging in any form. The institution is committed to
              maintaining a safe, respectful, and inclusive environment for all
              students, as mandated by the University Grants Commission (UGC)
              and Supreme Court of India.
            </p>
            <p>
              An Anti-Ragging Committee and a dedicated helpline are in place to
              address complaints promptly and ensure preventive measures are
              followed. Awareness programs and orientation sessions are
              organized regularly to educate students about their rights and
              responsibilities.
            </p>
            <p>
              Every student is encouraged to report any incident of ragging, and{" "}
              <strong>strict disciplinary actions</strong> are taken against
              those found guilty, ensuring a campus free from fear and
              harassment.
            </p>
          </div>
        </div>
        ...
        {/* Emergency Contacts */}
        <div className="bg-linear-to-rfrom-red-600 to-orange-600 rounded-2xl shadow-xl p-10 mb-12 text-white">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {reportingChannels.map((channel, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-linear-to-rfrom-red-600 to-orange-600  shadow-xl  mb-12   bg-opacity-20 backdrop-blur-sm rounded-xl p-6 text-center"
                >
          ...
          <div className="mt-8 bg-linear-to-rfrom-red-600 to-orange-600 rounded-2xl shadow-xl mb-12 bg-opacity-20 backdrop-blur-sm  p-6 text-center">
            ...
            <p className="text-sm mt-0 opacity-90">
              You can also report online at www.antiragging.in
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {whatIsRagging.map((item, index) => (
              <div
                key={index}
                className="flex items-start bg-red-50 border-l-4 border-red-500 rounded-lg p-4"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {preventiveMeasures.map((measure, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-linear-to-rfrom-red-500 to-orange-500 w-16 h-16 rounded-full flex items-center justify-center text-white mb-4">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-xl p-10 mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, index) => (
              ...
              >
                <div className="bg-linear-to-rfrom-blue-600 to-indigo-600 w-16 h-16 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                  {step.step}
                </div>
        ...
        {/* Punishments */}
        <div className="bg-linear-to-rfrom-orange-600 to-red-600 rounded-2xl shadow-xl p-10 mb-12 ">
          <div className="flex items-center justify-center mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12">
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="border-l-4 border-red-500 bg-gray-50 rounded-lg p-6"
              >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-700 mb-3">
                Register complaints and submit mandatory affidavits
              </p>
              <a
                href="https://www.antiragging.in"
                target="_blank"
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-700 mb-3">
                Read the complete UGC regulations on curbing ragging
              </p>
              <a
        ...
        <div className="bg-white rounded-2xl shadow-xl p-12 text-center border-t-4 border-green-600">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed mb-6">
            Every student deserves a safe and supportive environment. If you see
            something, say something. Your courage to report can save someone
            from harassment and trauma.
          </p>
