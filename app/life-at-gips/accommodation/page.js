...
export default function Accommodation() {
  return (
    <main className="bg-gradient-to-br from-blue-50 via-cyan-50 to-sky-100 text-gray-800">
      {/* ==================== HERO SECTION ==================== */}
      <section className="relative h-[85vh] flex items-center justify-center bg-linear-to-rfrom-cyan-700 via-blue-700 to-sky-600 text-white">
        ...
        <div className="relative z-10 text-center max-w-3xl px-6">
          ...
          <p className="text-lg md:text-xl text-cyan-100 leading-relaxed">
            Comfortable, secure, and student-friendly hostels designed to
            provide a peaceful environment that nurtures both learning and
            living.
          </p>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-8">
            At Garhwal Institute of Paramedical Sciences, we understand that a
            comfortable and safe living environment is essential for students’
            success. Our hostels offer not just accommodation, but a space to
            grow, connect, and recharge.
          </p>
          <Image
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            {/* Boys Hostel */}
            <div className="bg-linear-to-rfrom-sky-50 to-cyan-100 p-8 rounded-2xl shadow-md hover:shadow-lg">
              <Image
              ...
              <p className="text-gray-600 leading-relaxed">
                The boys’ hostel is equipped with spacious rooms, a gym corner,
                and recreational areas. Supervised by a dedicated warden, it
                ensures discipline and security without compromising freedom.
              </p>
            </div>

            {/* Girls Hostel */}
            <div className="bg-linear-to-rfrom-blue-50 to-cyan-100 p-8 rounded-2xl shadow-md hover:shadow-lg">
              <Image
                src="/api/placeholder/500/300"
                alt="Girls Hostel"
                width={500}
              ...
              <p className="text-gray-600 leading-relaxed">
                Our girls’ hostel prioritizes safety, privacy, and comfort. The
                facility is monitored round-the-clock and includes laundry,
                Wi-Fi, and healthy dining options for a peaceful living
                experience.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-blue-50 via-cyan-50 to-sky-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            To maintain harmony and discipline, GIPS hostels follow a set of
            rules that ensure every resident enjoys a respectful and safe
            environment.
          </p>
          ...
          <ul className="text-left list-disc list-inside text-gray-700 leading-relaxed space-y-3">
            ...
            <li>
              Students must maintain cleanliness in their rooms and common
              areas.
            </li>
            <li>
              Electrical appliances like heaters or irons require prior
              permission.
            </li>
      ...
      {/* ==================== CALL TO ACTION ==================== */}
      <section className="py-20 bg-linear-to-rfrom-cyan-700 via-blue-700 to-sky-600 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-4xl font-bold mb-6">
            Experience the GIPS Hostel Life
          </h2>
          <p className="text-lg text-cyan-100 mb-8">
            Join a vibrant, supportive, and comfortable student community where
            learning continues beyond classrooms.
          </p>
