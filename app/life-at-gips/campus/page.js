...
export default function CampusLife() {
  ...
  const studentLife = [
    {
      ...
      icon: BookOpen,
      description:
        "Dedicated faculty mentorship, remedial classes, and study groups",
    },
    {
    ...
    },
    {
      ...
      icon: Smile,
      description:
        "Personality development, leadership training, and skill workshops",
    },
    {
      aspect: "Recreation",
      icon: Coffee,
      description:
        "Cafeteria hangouts, sports activities, and entertainment zones",
    },
  ];
  ...
  const campusHighlights = [
    ...
    {
      title: "Wi-Fi Enabled",
      description: "High-speed internet throughout campus",
      icon: "📶",
    },
    {
    ...
    {
      title: "Active Clubs",
      description: "Multiple societies for every interest",
      icon: "🎯",
    },
  ];
  ...
  const dayInLife = [
    ...
    {
      time: "9:00 AM",
      activity: "Classes and practical sessions begin",
      icon: "📖",
    },
    ...
    {
      time: "5:00 PM",
      activity: "Sports, gym, or club activities",
      icon: "⚽",
    },
    { time: "7:00 PM", activity: "Dinner and relaxation", icon: "🌙" },
    {
      time: "8:00 PM",
      activity: "Study time, assignments, projects",
      icon: "💻",
    },
  ...
  const testimonials = [
    {
      ...
      hostel: "Boys Hostel",
      message:
        "Campus life at GIPS has been incredible! The hostel feels like a second home, and the friends I've made here are for life.",
    },
    {
      name: "Sneha Patel",
      ...
      hostel: "Girls Hostel",
      message:
        "The best part about GIPS is the supportive environment. From academics to extracurriculars, there's something for everyone!",
    },
    {
      name: "Rahul Singh",
      ...
      hostel: "Day Scholar",
      message:
        "The campus facilities are amazing! The library, labs, and sports facilities make learning enjoyable and holistic.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 mt-0">
      {/* Hero Section */}
      <div className="bg-linear-to-rfrom-green-600 via-blue-600 to-purple-600 text-white px-8 py-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-2xl text-green-100 max-w-4xl mx-auto leading-relaxed">
            Where Learning Meets Living - Experience a Vibrant, Inclusive, and
            Memorable Journey
          </p>
          <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {campusHighlights.slice(0, 4).map((highlight, index) => (
              <div
                key={index}
                className="bg-blue-400 bg-opacity-20 backdrop-blur-sm p-4 rounded-xl"
              >
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-green-600">
          <h2 className="text-4xl font-bold text-gray-800 mb-6">
            Welcome to GIPS Campus
          </h2>
          <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
            <p>
              The campus of GIPS offers a vibrant and inclusive environment that
              blends academics with holistic development. Students enjoy access
              to modern classrooms, well-equipped laboratories, comprehensive
              libraries, and diverse recreational spaces that make learning
              engaging and enjoyable.
            </p>
            <p>
              Clubs and societies on campus encourage participation in diverse
              fields such as innovation, health awareness, environmental care,
              and social outreach programs. These initiatives help students
              develop leadership skills, social responsibility, and a
              well-rounded personality.
            </p>
            <p>
              With a perfect mix of learning and leisure, GIPS ensures that
              every student&apos;s journey is memorable, engaging, and filled
              with opportunities to grow personally and professionally. Our
              campus is not just a place to study - it&apos;s a community where
              friendships are forged and memories are created.
            </p>
          </div>
        </div>
        ...
        {activeTab === "overview" && (
          <div>
            ...
            <div className="bg-linear-to-rfrom-blue-600 to-purple-600 rounded-2xl shadow-xl p-10 mb-12">
              <h2 className="text-4xl font-bold mb-8 text-center">
                Student Life at GIPS
              </h2>
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {testimonials.map((testimonial, index) => (
                  <div
                    key={index}
                    className="bg-white rounded-2xl shadow-lg p-8 border-t-4 border-green-600"
                  >
                    <div className="flex items-center mb-4">
                      <div className="bg-linear-to-rfrom-green-500 to-blue-500 w-14 h-14 rounded-full flex items-center justify-center text-white font-bold text-xl mr-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {campusFacilities.map((facility) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`bg-linear-to-r${facility.color} p-6 text-white`}
                    >
        ...
        {activeTab === "clubs" && (
          <div>
            ...
            <div className="bg-linear-to-rfrom-green-600 to-blue-600 rounded-2xl shadow-xl p-10 text-white text-center">
              <Users className="w-16 h-16 mx-auto mb-6" />
              <h3 className="text-3xl font-bold mb-4">Join a Club Today!</h3>
              <p className="text-xl mb-6 max-w-3xl mx-auto">
                Every student is encouraged to join at least one club or
                society. It&apos;s a great way to pursue your interests, develop
          ...
          <div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
              <div className="space-y-4">
                {dayInLife.map((slot, index) => (
                  <div
                    key={index}
                    className="flex items-center bg-linear-to-rfrom-green-50 to-blue-50 rounded-xl p-6 hover:shadow-lg transition-all"
                  >
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl shadow-xl p-10 text-center">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                While this represents a typical schedule, every day at GIPS
                brings new experiences, surprises, and opportunities. From
                impromptu jam sessions to late-night study groups, from sports
                matches to cultural events - there&apos;s never a dull moment on
                campus!
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-12 mt-0 text-center">
          ...
          <h2 className="text-4xl font-bold text-gray-800 mb-4">
            Ready to Be Part of GIPS Family?
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Campus life at GIPS is more than just academics - it&apos;s about
            creating memories, building friendships, and discovering yourself.
