...
export default function After12th() {
  ...
  const courses = [
    {
      ...
      eligibility:
        "10+2 with Physics, Chemistry, Biology (PCB) - Min 50% marks",
      seats: "60",
      career:
        "Physiotherapist, Rehabilitation Specialist, Sports Therapist, Clinical Researcher",
    },
    {
      ...
      seats: "40",
      career:
        "Radiographer, MRI/CT Scan Technician, Imaging Specialist, Hospital Technologist",
    },
    {
      ...
      seats: "40",
      career:
        "OT Technician, Surgical Assistant, Sterilization Technician, Hospital Administrator",
    },
    {
      ...
      seats: "30",
      career:
        "Optometrist, Vision Therapist, Contact Lens Specialist, Eye Care Professional",
    },
    {
      ...
      seats: "30",
      career:
        "Optometry Technician, Vision Screening Specialist, Optical Store Manager",
    },
  ];
  ...
  const admissionProcess = [
    {
      ...
      description:
        "Fill the online application form on GIPS website with accurate details",
      duration: "May - June",
    },
    {
      step: 2,
      ...
      description:
        "Upload required documents (mark sheets, certificates, ID proof, photos)",
    ...
    },
    {
      ...
      description:
        "Appear for entrance examination or qualify through 10+2 merit",
      duration: "July",
    },
    {
      step: 4,
      ...
      description:
        "Check merit list on website. Selected candidates receive admission offer",
    ...
    },
    {
      ...
      description:
        "Attend counseling session with original documents for verification",
      duration: "August",
    },
    {
      step: 6,
  ...
  const whyChooseGIPS = [
    {
      ...
      description:
        "Approved by state medical council and affiliated with reputed university",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description:
        "95%+ placement record with top hospitals and healthcare centers",
    },
    {
      icon: BookOpen,
      title: "Practical Training",
      description:
        "Hands-on clinical exposure through hospital tie-ups and internships",
    },
  ];
  ...
  const faqs = [
    {
      question:
        "Can I apply if I have Biology and Mathematics but not Chemistry?",
      answer:
        "No, Physics, Chemistry, and Biology (PCB) are mandatory subjects for paramedical courses. Mathematics alone cannot substitute Chemistry.",
    },
    {
      question: "Is there any entrance exam for admission?",
      answer:
        "Admission is primarily merit-based on 10+2 marks. However, GIPS may conduct an entrance test for certain programs. Check the admission notification for specific course requirements.",
    },
    {
      question: "What is the fee structure? Are there any scholarships?",
      answer:
        "Fees vary by program (₹45,000 to ₹1,00,000 per year). Yes, scholarships are available based on merit and for economically weaker sections. Government scholarships are also applicable.",
    },
    {
      question: "Can I get direct admission without entrance test?",
      answer:
        "Yes, most courses offer merit-based admission based on 10+2 marks. However, seats are limited and admission is competitive.",
    },
    {
      question: "Is hostel facility available for outstation students?",
      answer:
        "Yes, GIPS provides separate hostel facilities for boys and girls with all modern amenities, dining hall, and 24/7 security.",
    },
    {
      question:
        "What are the job opportunities after completing these courses?",
      answer:
        "Graduates get placements in government and private hospitals, diagnostic centers, rehabilitation centers, clinics, and can also pursue higher studies or start their own practice.",
    },
  ];
      ...
      <div className="bg-linear-to-rfrom-blue-600 via-indigo-600 to-purple-600 text-white px-8 py-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
            Start Your Healthcare Career at Garhwal Institute of Paramedical
            Sciences
          </p>
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
          ...
          <div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-blue-600">
              <h2 className="text-4xl font-bold text-gray-800 mb-6">
                Welcome to GIPS Admissions
              </h2>
              <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                <p>
                  Students who have completed their 10+2 (Science stream with
                  Physics, Chemistry, and Biology) are eligible to apply for
                  various undergraduate programs offered by Garhwal Institute of
                  Paramedical Sciences. Our institution is committed to
                  providing quality education and practical training to students
                  aspiring to build a successful career in the healthcare
                  sector.
                </p>
                <p>
                  Admission to GIPS is strictly based on merit, ensuring that
                  only dedicated and deserving candidates get the opportunity to
                  pursue their dreams. We follow a transparent selection process
                  aligned with state and national guidelines, with adequate
                  representation for all categories as per government
                  reservation policies.
                </p>
                <p>
                  At GIPS, we offer comprehensive paramedical programs with
                  excellent infrastructure, experienced faculty, and strong
                  industry connections that ensure outstanding placement
                  opportunities for our graduates. Join us to embark on a
                  rewarding journey in healthcare!
                </p>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {eligibilityCriteria.map((criteria, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="bg-linear-to-rfrom-blue-500 to-purple-500 w-16 h-16 rounded-full flex items-center justify-center text-white mb-4">
            ...
            {/* Why Choose GIPS */}
            <div className="bg-linear-to-rfrom-indigo-600 to-purple-600 rounded-2xl shadow-xl p-10 mb-12 text-white">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {whyChooseGIPS.map((reason, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="bg-white/20 backdrop-blur-md rounded-xl p-6 text-center border border-white/30"
                    >
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {importantDates.map((item, index) => (
                  <div
                    key={index}
                    className="flex justify-between items-center bg-linear-to-rfrom-blue-50 to-purple-50 rounded-lg p-5 border-l-4 border-blue-600"
                  >
              ...
              <div className="mt-6 bg-orange-100 border-l-4 border-orange-500 p-4 rounded-lg">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <strong>Note:</strong> Dates are tentative and subject to
                    change. Please check the official website regularly for
                    updates.
                  </p>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              {courses.map((course, index) => (
                ...
                >
                  <div className="bg-linear-to-rfrom-blue-500 to-purple-500 p-6 text-white">
                  ...
                  <div className="p-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800 mb-2 flex items-center"></h4>
              ...
              <div className="space-y-6">
                {admissionProcess.map((process, index) => (
                  <div key={index} className="flex items-start">
                    <div className="bg-linear-to-rfrom-purple-600 to-pink-600 text-white w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mr-6 flex-shrink-0">
                      {process.step}
                    </div>
                    <div className="flex-1 bg-linear-to-rfrom-purple-50 to-pink-50 rounded-xl p-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {requiredDocuments.map((doc, index) => (
                  <div
                    key={index}
                    className="flex items-start bg-orange-50 rounded-lg p-4 border-l-4 border-orange-500"
                  >
              ...
              <div className="mt-6 bg-blue-100 border-l-4 border-blue-500 p-4 rounded-lg">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    ...
                    self-attested. Original documents must be carried during
                    counseling for verification.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-12 mt-0 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Our admission team is here to assist you. Contact us for any queries
            regarding courses, eligibility, or application process.
          </p>
          ...
          <a
            href="/admissions"
            className="bg-linear-to-rfrom-blue-600 to-purple-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-xl transition-all transform hover:scale-105"
          >
