...
export default function Scholarships() {
  ...
  const scholarshipTypes = [
    {
      ...
      emoji: "🏆",
      description:
        "Rewards for academic excellence and outstanding performance",
      scholarships: [
        {
  ...
  const applicationProcess = [
    ...
    },
    {
      ...
      description:
        "Gather all required certificates, income proof, and academic records",
    },
    {
      step: 3,
      title: "Fill Application Form",
      description:
        "Complete scholarship application form available at admission office",
    },
    {
      step: 4,
      title: "Submit Documents",
      description:
        "Submit application with all supporting documents before deadline",
    },
    {
      step: 5,
      title: "Verification",
      description:
        "Committee verifies documents and eligibility of all applicants",
    },
    {
      step: 6,
      title: "Selection & Approval",
      description:
        "Scholarship committee reviews and approves eligible candidates",
    },
    {
      step: 7,
      title: "Disbursement",
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes, you can apply for multiple scholarships if you meet the eligibility criteria. However, you will be awarded only one scholarship - whichever offers maximum benefit. Government and institutional scholarships cannot be combined.",
    },
    {
      question: "When will I receive the scholarship amount?",
      answer:
        "Merit-based scholarships are typically adjusted in the fee structure at the time of admission or semester fee payment. Government scholarships are disbursed as per government timelines, usually after document verification is complete.",
    },
    {
      question: "Will the scholarship continue for all years?",
      answer:
        "Merit scholarships for 90%+ students continue if you maintain 75% marks annually. Other scholarships are reviewed yearly based on academic performance and eligibility criteria.",
    },
    {
      question: "What happens if I don't maintain the required percentage?",
      answer:
        "If your marks fall below the required percentage, the scholarship may be discontinued from the next academic year. However, you can reapply if you improve your performance.",
    },
    {
      question: "Is there a scholarship for sibling students?",
      answer:
        "Yes, if two or more siblings are studying at GIPS simultaneously, a 10% fee concession is provided to one of the siblings (the one with higher fees pays full, others get 10% off).",
    },
    {
      question: "How do I apply for government scholarships?",
      answer:
        "For government scholarships, you need to apply through the National Scholarship Portal (scholarships.gov.in) and also submit application at GIPS admission office with all required documents for institutional processing.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 mt-0">
      {/* Hero Section */}
      <div className="bg-linear-to-rfrom-yellow-600 via-orange-600 to-red-600 text-white px-8 py-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-2xl text-yellow-100 max-w-4xl mx-auto leading-relaxed">
            Empowering Dreams Through Financial Support - Making Quality
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className={`px-6 py-3 rounded-lg font-semibold transition-all ${
                activeTab === "overview"
                  ? "bg-linear-to-rfrom-orange-600 to-red-600 text-white shadow-lg"
          ...
          <div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-orange-600">
              <h2 className="text-4xl font-bold text-gray-800 mb-6">
                Scholarship Program at GIPS
              </h2>
              <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                <p>
                  At Garhwal Institute of Paramedical Sciences, we believe that
                  financial constraints should never be a barrier to quality
                  education. Our comprehensive scholarship program is designed
                  to support meritorious and deserving students, enabling them
                  to pursue their dreams in the healthcare sector without
                  financial burden.
                </p>
                <p>
                  GIPS provides a wide range of scholarships including
                  merit-based awards for academic excellence, government
                  scholarships for reserved categories, need-based financial aid
                  for economically weaker students, and special scholarships for
                  various categories including sports achievers, girls
                  education, and students with disabilities.
                </p>
                <p>
                  Our scholarship committee carefully reviews each application
                  to ensure that deserving candidates receive the support they
                  need. We are proud that over 40% of our students benefit from
                  various scholarship schemes, making education accessible and
                  affordable for all.
                </p>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {eligibilityCriteria.map((criteria, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="bg-linear-to-rfrom-orange-500 to-red-500 w-16 h-16 rounded-full flex items-center justify-center text-white mb-4">
            ...
            {/* Important Dates */}
            <div className="bg-linear-to-rfrom-blue-600 to-indigo-600 rounded-2xl shadow-xl p-10 text-white mb-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {importantDates.map((item, index) => (
                  <div
                    key={index}
                    className="bg-white/20 backdrop-blur-md rounded-xl p-5 border border-white/30"
                  >
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10">
              ...
              <p className="text-gray-700 mb-6">
                Apart from institutional scholarships, students can also apply
                for various government and private scholarships:
              </p>
              <div className="grid md:grid-cols-2 gap-6">
                {externalScholarships.map((scholarship, index) => (
                  <div
                    key={index}
                    className="border-2 border-gray-200 rounded-xl p-6 hover:border-orange-500 transition-all"
                  >
          ...
          <div className="space-y-8">
            {scholarshipTypes.map((type) => {
              ...
              return (
                ...
                >
                  <div className={`bg-linear-to-r${type.color} p-8 text-white`}>
                  ...
                  <div className="p-8">
                    <div className="space-y-6">
                      {type.scholarships.map((scholarship, index) => (
                        <div
                          key={index}
                          className="bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-xl p-6 hover:border-orange-400 transition-all"
                        >
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl shadow-xl p-10">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {requiredDocuments.map((doc, index) => (
                  <div
                    key={index}
                    className="flex items-start bg-white rounded-lg p-4 shadow-md border-l-4 border-orange-500"
                  >
              ...
              <div className="mt-6 bg-white border-l-4 border-red-500 p-4 rounded-lg">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    ...
                    self-attested. Original documents will be verified at the
                    time of interview. Incomplete applications will be rejected.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10">
              ...
              <div className="space-y-6">
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className="border-l-4 border-orange-500 bg-orange-50 rounded-lg p-6"
                  >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-12 mt-0 text-center">
          ...
          <h2 className="text-4xl font-bold text-gray-800 mb-4">
            Need Help with Scholarship Application?
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Contact our scholarship cell for any queries or assistance with your
            application.
          </p>
          ...
          <button className="bg-linear-to-rfrom-orange-600 to-red-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-xl transition-all transform hover:scale-105">
