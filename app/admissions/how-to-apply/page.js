...
export default function HowToApply() {
  ...
  const applicationSteps = [
    {
      ...
      description:
        "Go to the official GIPS website and click on 'Admissions' or 'Apply Now' button",
      icon: ExternalLink,
      details: [
    ...
    },
    {
      ...
      description:
        "Register with your email ID and mobile number to create login credentials",
      icon: User,
      details: [
    ...
    },
    {
      ...
      description:
        "Scan and upload all required documents in specified format (PDF/JPG, max 2MB each)",
      icon: Upload,
      details: [
    ...
    },
    {
      ...
      description:
        "Save confirmation page and take printout for future reference",
      icon: Download,
      details: [
  ...
  const requiredDocuments = [
    ...
    {
      doc: "Caste Certificate (if applicable)",
      format: "PDF/JPG",
      size: "Max 2MB",
    },
    ...
    { doc: "Aadhar Card", format: "PDF/JPG", size: "Max 2MB" },
    {
      ...
      format: "JPG",
      size: "Max 100KB, White Background",
    },
    {
      doc: "Signature Image",
      format: "JPG",
      size: "Max 50KB, White Background",
    },
  ];
  ...
  const importantTips = [
    {
      ...
      description:
        "Verify personal details, marks, and contact information before submission",
    },
    {
      icon: Upload,
    ...
    },
    {
      ...
      description:
        "Don't wait for last day, submit at least 2-3 days before deadline",
    },
    {
      icon: Mail,
    ...
    },
    {
      ...
      description:
        "Submit only one application. Multiple applications will be rejected",
    },
  ];
  ...
  const afterSubmission = [
    ...
    },
    {
      ...
      description:
        "Merit list will be published on website based on eligibility and marks",
    },
    {
      step: "Attend Counseling",
      description:
        "If selected, attend counseling with original documents on scheduled date",
    },
    {
      step: "Complete Admission",
      description:
        "Pay admission fee, submit documents, and complete enrollment formalities",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-gray-600">
                Fast, convenient, and recommended method
              </p>
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-blue-600">
              ...
              <p className="text-lg text-gray-700 mb-4">
                Follow these simple steps to complete your online application.
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <strong>Estimated Time:</strong> 45 minutes to 1 hour for
            ...
            <div className="space-y-6 mb-12">
              {applicationSteps.map((step) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center bg-linear-to-rfrom-blue-500 to-indigo-500 p-6 text-white">
        ...
        {activeMode === "offline" && (
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-purple-600">
              ...
              <p className="text-lg text-gray-700 mb-4">
                For candidates who prefer manual application submission, follow
                these steps.
              </p>
              <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded-lg">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    <strong>Note:</strong> Online application is faster and
                    recommended. Offline applications may take longer to
                    process.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6 mb-12">
              {offlineSteps.map((step) => (
                <div
                  ...
                  className="bg-white rounded-2xl shadow-xl overflow-hidden"
                >
                  <div className="flex items-center bg-linear-to-rfrom-purple-500 to-pink-500 p-6 text-white">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-linear-to-rfrom-orange-500 to-red-500 text-white">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12">
          ...
          <div className="space-y-4">
            {afterSubmission.map((item, index) => (
              <div
                key={index}
                className="flex items-start bg-linear-to-rfrom-blue-50 to-purple-50 rounded-xl p-6"
              >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Our admission helpdesk is available to assist you with any queries
