      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white shadow-md rounded-2xl p-8 mb-6">
          ...
          <p className="text-gray-700 text-lg">
            ...
            actively to community welfare and make a meaningful difference in
            people&apos;s lives.
          </p>
        </div>
        ...
        <div className="bg-green-50 shadow-md rounded-2xl p-8 mb-6">
          ...
          <p className="text-gray-700 mb-4">
            Our community outreach initiatives focus on creating sustainable
            development and improving quality of life across various sectors.
            Through these programs, students gain hands-on experience in social
            work and leadership.
          </p>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Medical camps, health seminars, and wellness workshops
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg">
              <h3 className="font-semibold text-green-700 mb-2">
              ...
              <p className="text-sm text-gray-600">
                Scholarships and educational programs for disadvantaged youth
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg">
              <h3 className="font-semibold text-green-700 mb-2">
              ...
              <p className="text-sm text-gray-600">
                Tree plantation and eco-friendly sustainability initiatives
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg">
              <h3 className="font-semibold text-green-700 mb-2">
              ...
              <p className="text-sm text-gray-600">
                Emergency response and humanitarian aid programs
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-purple-50 shadow-md rounded-2xl p-8 mb-6">
          ...
          <p className="text-gray-700 mb-4">
            We believe that active participation of students in social
            responsibility activities helps shape compassionate healthcare
            professionals. Our volunteering opportunities include:
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>
              Regular volunteer opportunities in nearby villages and
        ...
        <div className="bg-orange-50 shadow-md rounded-2xl p-8 mb-6">
          ...
          <p className="text-gray-700 mb-4">
            Through our sustained efforts, GIPS has made a positive impact on
            thousands of lives. Our goals for the future include:
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Expanding healthcare services to remote areas</li>
            <li>
              Establishing specialized health clinics in underserved regions
            </li>
            <li>
              Increasing student participation in community service activities
            </li>
            <li>
              Creating sustainable development models for long-term social
              impact
            </li>
            <li>
              Strengthening partnerships with government and private
              organizations
            </li>
          </ul>
        </div>
        ...
        {/* Call to Action */}
        <div className="bg-linear-to-rfrom-blue-600 to-blue-800 shadow-md rounded-2xl p-8 mb-6 text-white text-center">
          <h2 className="text-2xl font-semibold mb-3">Join Our Mission</h2>
          <p className="mb-4">
            Be part of GIPS&apos;s social responsibility journey and contribute
            to building a healthier and more equitable society.
          </p>
          <p className="text-blue-100">
            Contact us to learn more about volunteering opportunities and
            partnerships.
          </p>
        </div>
