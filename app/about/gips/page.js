  ...
  const highlights = [
    {
      ...
      description:
        "Affiliated with H.N.B. Uttarakhand Medical Education University, Dehradun",
    },
    {
      icon: Users,
      title: "Experienced Faculty",
      description:
        "Highly qualified faculty with years of teaching and clinical experience",
    },
    {
      icon: BookOpen,
      title: "Modern Infrastructure",
      description:
        "State-of-the-art laboratories, libraries, and training facilities",
    },
    {
      icon: TrendingUp,
      title: "Excellent Placements",
      description:
        "95%+ placement record with top hospitals and healthcare institutions",
    },
  ];
  ...
  const visionMission = [
    {
      ...
      icon: Target,
      content:
        "To be recognized as a leading paramedical institution in India, known for producing competent healthcare professionals who contribute meaningfully to society through quality patient care and medical innovation.",
    ...
    },
    {
      ...
      icon: Heart,
      content:
        "To provide comprehensive paramedical education that combines theoretical knowledge with practical skills, fostering ethical values, professional competence, and a commitment to lifelong learning in healthcare.",
  ...
  const values = [
    {
      value: "Excellence",
      description:
        "Striving for the highest standards in education and healthcare",
    },
    {
      value: "Integrity",
      description:
        "Maintaining ethical practices and transparency in all endeavors",
    },
    {
      value: "Innovation",
    ...
    {
      value: "Compassion",
      description: "Caring for patients and community with empathy and respect",
    },
    {
      value: "Collaboration",
      description: "Working together for better healthcare outcomes",
    },
    {
      value: "Responsibility",
      description: "Commitment to social and professional accountability",
    },
  ];
      ...
      <div className="bg-linear-to-rfrom-blue-600 via-indigo-600 to-purple-600 text-white px-8 py-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
            Garhwal Institute of Paramedical Sciences - Shaping Future
          ...
          <div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-blue-600">
              ...
              <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                <p>
                  ...
                  paramedical training and allied health sciences in
                  Uttarakhand.
                </p>
                <p>
                  Located in the serene hills of Pauri Garhwal, our institute
                  provides an ideal learning environment where students can
                  focus on their academic and professional development. We are
                  proud to be affiliated with H.N.B. Uttarakhand Medical
                  Education University, Dehradun, ensuring that our programs
                  meet the highest educational standards and are recognized
                  nationwide.
                </p>
                <p>
                  At GIPS, we believe in holistic development — combining
                  academic rigor with practical exposure. With experienced
                  faculty, modern laboratories, well-equipped libraries, and
                  strong industry linkages, our students are prepared to become
                  skilled, compassionate, and competent healthcare professionals
                  who can make a real difference in people&apos;s lives.
                </p>
                <p>
                  Our curriculum is designed to provide comprehensive
                  theoretical knowledge alongside extensive hands-on training
                  through clinical rotations, internships, and hospital tie-ups.
                  We emphasize not just technical skills but also ethical
                  values, communication abilities, and professional conduct that
                  are essential in the healthcare sector.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {values.map((item, index) => (
                  <div
                    key={index}
                    className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 border-l-4 border-blue-600 hover:shadow-lg transition-all"
                  >
            ...
            <div className="bg-linear-to-rfrom-green-600 to-teal-600 rounded-2xl shadow-xl p-10 text-white text-center">
              ...
              <p className="text-xl mb-6 text-green-100 max-w-3xl mx-auto">
                GIPS is affiliated with H.N.B. Uttarakhand Medical Education
                University, Dehradun, and approved by the State Medical Faculty.
                Our programs are recognized by relevant regulatory bodies,
                ensuring quality education and nationwide recognition of
                degrees.
              </p>
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-purple-600">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                GIPS takes pride in its team of highly qualified, experienced,
                and dedicated faculty members. Our professors bring a wealth of
                academic knowledge and practical clinical experience, ensuring
                that students receive the best possible education and
                mentorship. Our faculty members are not just teachers but
                mentors who guide students throughout their academic journey and
                beyond.
              </p>
            </div>
                      ...
                      >
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-left space-y-2 text-sm text-gray-600">
                            ...
                            {faculty.degree && (
                              <p className="font-semibold text-gray-800 mt-0">
                                {faculty.degree}
                              </p>
                            )}
                            {faculty.hospital && (
            ...
            <div className="bg-linear-to-rfrom-yellow-400 via-orange-500 to-red-500 rounded-2xl shadow-xl p-10 text-white text-center">
              ...
              <p className="text-xl mb-6 max-w-3xl mx-auto">
                Our faculty members have published numerous research papers,
                received teaching excellence awards, and actively contribute to
                the advancement of paramedical sciences through their research,
