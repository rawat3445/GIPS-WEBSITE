  ...
  const contactMethods = [
    {
      ...
      details:
        "Vill. & P.O. Kyark, Patti Idealshyun, Dist. Pauri Garhwal, Uttarakhand - 246001",
    },
    {
      icon: "📧",
      title: "Email",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white shadow-md rounded-2xl p-8 mb-8">
          ...
          <p className="text-gray-700 text-lg">
            GIPS is strategically located in Pauri Garhwal, Uttarakhand with
            excellent accessibility from major cities. Whether you&apos;re
            visiting our campus for admissions, events, or other purposes,
            we&apos;ve made it easy for you to find us. Here&apos;s all the
            information you need to reach our college.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {contactMethods.map((method) => (
            <div
              key={method.icon}
              className="bg-white shadow-md rounded-2xl p-6 border-t-4 border-blue-600 hover:shadow-lg transition-shadow"
            >
            ...
            <div className="bg-white shadow-md rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {transportOptions.map((option) => (
                  <div
                    key={option.id}
                    className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-xl p-6 hover:shadow-lg transition-shadow"
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-orange-600 to-orange-800 shadow-md rounded-2xl p-8 text-white">
              ...
              <p className="text-sm mb-4">
                We welcome prospective students, parents, and visitors to
                explore our campus. Schedule a guided tour today!
              </p>
        ...
        <div className="bg-white shadow-md rounded-2xl overflow-hidden mb-8">
          <div className="h-96 md:h-96 bg-gray-200 relative">
            <div className="h-96 md:h-96 bg-gray-200 relative">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d55187.17768054628!2d78.7179829!3d30.1743202!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3909a5b487640e03%3A0xf61d9be9411bf214!2sGarhwal%20Institute%20of%20Paramedical%20Sciences!5e0!3m2!1sen!2sin!4v1760341326908!5m2!1sen!2sin"
              >
                {" "}
              </iframe>
            </div>
          ...
          <div className="p-6 bg-blue-50 border-t-2 border-blue-200">
            ...
            <p className="text-gray-700 text-sm mb-4">
              Our campus is located in Vill. & P.O. Kyark, Patti Idealshyun,
              Pauri Garhwal. The map above shows our exact location with a
              pinpoint marker. You can also search &quot;Garhwal Paramedical
              Institute Kyark&quot; on Google Maps.
            </p>
            <a
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-blue-50 p-6 rounded-xl border border-blue-200">
              ...
              <p className="text-gray-700 text-sm mb-3">
                <strong>Distance:</strong> 150.9 km | <strong>Time:</strong> 3.5
                - 4 hours
              </p>
              <p className="text-gray-700 text-sm">
                Take NH48 towards Mussoorie and continue towards Pauri Garhwal.
                Follow signage to reach our campus.
              </p>
            </div>
            <div className="bg-green-50 p-6 rounded-xl border border-green-200">
              <h3 className="font-semibold text-green-800 mb-3">From Delhi</h3>
              <p className="text-gray-700 text-sm mb-3">
                <strong>Distance:</strong> 350 km | <strong>Time:</strong> 7 - 8
                hours
              </p>
              <p className="text-gray-700 text-sm">
                Drive via NH48 towards Haridwar, then continue to Dehradun and
                towards Pauri Garhwal.
              </p>
            </div>
            <div className="bg-purple-50 p-6 rounded-xl border border-purple-200">
              ...
              <p className="text-gray-700 text-sm mb-3">
                <strong>Distance:</strong> 133 km | <strong>Time:</strong> 3.5 -
                4 hours
              </p>
              <p className="text-gray-700 text-sm">
                Head towards Dehradun via NH48, then take the route towards
                Pauri Garhwal.
              </p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 shadow-md rounded-2xl p-8 mb-8 text-white text-center">
          ...
          <p className="mb-4">
            Our admission and visitor support team is ready to help you plan
            your visit. Get in touch with us today!
          </p>
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <a
              href="mailto:garhwalparamedicalinstitute@gmail.com"
              className="bg-white text-blue-700 font-semibold px-6 py-2 rounded-lg hover:bg-blue-50 transition-colors"
            >
              Send Email
            </a>
            <a
              href="tel:+917454998289"
              className="bg-white text-blue-700 font-semibold px-6 py-2 rounded-lg hover:bg-blue-50 transition-colors"
            >
              Call Now
            </a>
