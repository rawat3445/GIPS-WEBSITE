  ...
  const missionPoints = [
    {
      ...
      description:
        "Provide comprehensive paramedical education with modern facilities, updated curriculum, and industry-relevant training",
    },
    {
      icon: Lightbulb,
      title: "Research & Innovation",
      description:
        "Encourage research, innovation, and evidence-based practices in healthcare sciences and medical technology",
    },
    {
      icon: Heart,
      title: "Values & Ethics",
      description:
        "Promote values of empathy, integrity, compassion, and dedicated service to society and patients",
    },
    {
      icon: Users,
      title: "Holistic Development",
      description:
        "Foster overall personality development combining technical skills with soft skills and professional conduct",
    },
    {
      icon: Globe,
      title: "Industry Collaboration",
      description:
        "Build strong partnerships with hospitals, healthcare institutions, and industry for practical exposure",
    },
    {
      icon: TrendingUp,
      title: "Continuous Improvement",
      description:
        "Strive for excellence through continuous evaluation, feedback, and enhancement of educational processes",
    },
  ];
  ...
  const strategicGoals = [
    {
      ...
      description:
        "Maintain high academic standards through quality teaching, regular assessments, and continuous curriculum updates",
    },
    {
      goal: "Infrastructure Development",
      description:
        "Continuously upgrade facilities, laboratories, equipment, and learning resources",
    },
    {
      goal: "Faculty Enhancement",
      description:
        "Recruit qualified faculty and provide regular training, workshops, and professional development opportunities",
    },
    {
      goal: "Student Success",
      description:
        "Ensure 95%+ placement rate, support higher education aspirations, and nurture entrepreneurship",
    },
    {
      goal: "Research Promotion",
      description:
        "Establish research centers, provide funding, and encourage publication in reputed journals",
    },
    {
      goal: "Community Engagement",
      description:
        "Organize health camps, awareness programs, and contribute to public health initiatives",
    },
  ];
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-blue-600">
          ...
          <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
            <p className="text-2xl font-semibold text-indigo-700 mb-6">
              &quot;To be a center of excellence in paramedical education,
              research, and healthcare service&quot;
            </p>
            <p>
              At Garhwal Institute of Paramedical Sciences (GIPS), we envision
              ourselves as a leading institution that sets benchmarks in
              paramedical education and allied health sciences. Our vision is to
              create a dynamic learning ecosystem where students not only
              acquire technical knowledge but also develop into compassionate,
              ethical, and competent healthcare professionals.
            </p>
            <p>
              We aspire to be recognized nationally and internationally for our
              academic excellence, innovative teaching methodologies,
              cutting-edge research, and contributions to healthcare delivery.
              Our ultimate vision is to produce graduates who make meaningful
              differences in people&apos;s lives through quality patient care,
              medical innovation, and community health service.
            </p>
            <p>
              We aim to nurture professionals who combine technical expertise
              with human values - individuals who are not just skilled
              practitioners but also caring healers, ethical decision-makers,
              and responsible citizens committed to improving healthcare
              accessibility and quality in society.
            </p>
          </div>
        </div>
        ...
        <div className="mb-12">
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-t-2xl p-8 text-white">
            ...
            <p className="text-xl mt-4 text-purple-100">
              Transforming aspirations into achievements through quality
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white/20 backdrop-blur-md rounded-xl p-6 text-center border border-white/30 hover:bg-white/30 transition-all"
                >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              We are committed to creating a nurturing educational environment
              where every student can realize their full potential. Through
              innovative teaching, dedicated faculty, modern infrastructure, and
              strong industry connections, we prepare our students not just for
              jobs, but for meaningful careers in healthcare.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              At GIPS, we don&apos;t just educate - we inspire, empower, and
              transform lives. We believe that when our students succeed,
              healthcare improves, communities thrive, and society benefits.
              This is our vision, our mission, and our promise to every student
