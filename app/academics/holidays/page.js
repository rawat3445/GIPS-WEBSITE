...
export default function Holidays() {
  ...
  const holidays = [
    ...
    },
    {
      date: "2025-02-26",
      day: "Wednesday",
      occasion: "Maha Shivratri Holiday",
      type: "festival",
    ...
    // March 2025
    {
      date: "2025-03-12",
      day: "Wednesday",
      occasion: "Holi Vacation Start",
      type: "academic",
      description: "Festival of colors - vacation begins",
      month: "March",
    },
    {
      date: "2025-03-13",
      day: "Thursday",
      occasion: "Holi Vacation",
      type: "academic",
      description: "Continued vacation",
      month: "March",
    },
    {
      date: "2025-03-14",
    ...
    },
    {
      date: "2025-03-15",
      day: "Saturday",
      occasion: "Holi Vacation End",
      type: "academic",
      description: "Last day of Holi vacation",
      month: "March",
    },
    ...
    // June 2025
    {
      date: "2025-06-01",
      day: "Sunday",
      occasion: "Summer Vacation Start",
      type: "academic",
    ...
    // July 2025
    {
      ...
      occasion: "Harela",
      type: "festival",
      description: "Traditional festival of Uttarakhand",
      month: "July",
    },
    ...
    // September 2025
    {
      date: "2025-09-29",
      day: "Monday",
      occasion: "Dussehra Start",
      type: "festival",
      description: "Victory of good over evil - celebration begins",
      month: "September",
    },
    {
      date: "2025-09-30",
      ...
      occasion: "Dussehra",
      type: "festival",
      description: "Continued celebration",
      month: "September",
    },
    ...
    },
    {
      date: "2025-10-02",
      day: "Thursday",
      occasion: "Dussehra End",
      type: "festival",
      description: "Last day of Dussehra celebration",
      month: "October",
    },
    {
      date: "2025-10-18",
      day: "Saturday",
      occasion: "Diwali Holiday Start",
      type: "festival",
      description: "Festival of lights - holiday begins",
      month: "October",
    },
    {
      date: "2025-10-19",
      day: "Sunday",
      occasion: "Diwali Holiday",
      type: "festival",
      description: "Continued holiday",
      month: "October",
    },
    {
      date: "2025-10-20",
    ...
    },
    {
      date: "2025-10-22",
      day: "Wednesday",
      occasion: "Diwali Holiday End",
      type: "festival",
      description: "Last day of Diwali holidays",
      month: "October",
    },
    ...
    // January 2026
    {
      date: "2026-01-01",
      day: "Thursday",
      occasion: "Winter Vacation Start",
      type: "academic",
      description: "Year-end break begins",
      month: "January",
    },
    {
      date: "2026-01-20",
      day: "Tuesday",
      occasion: "Winter Vacation End",
      type: "academic",
      description: "Last day of winter vacation",
      month: "January",
    },
  ];
  ...
  const filteredHolidays = holidays.filter((holiday) => {
    ...
    const monthMatch =
      selectedMonth === "all" || holiday.month === selectedMonth;
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50 mt-0">
      ...
      <div className="bg-linear-to-rfrom-orange-600 via-pink-600 to-purple-600 text-white px-8 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="  bg-opacity-30 backdrop-blur-sm rounded-xl p-6 max-w-3xl mx-auto">
            <p className="text-center text-lg">
              Plan your year ahead with our comprehensive list of holidays,
              festivals, and academic breaks observed at GIPS throughout the
              academic session.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
          ...
          {holidayCategories.map((category) => (
            ...
            >
              ...
              <div className="text-4xl font-bold">
                {getTotalHolidaysByType(category.id)}
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">
            {filterType === "all"
              ? "All Holidays"
              : holidayCategories.find((c) => c.id === filterType)?.name}
        ...
        <div className="bg-linear-to-rfrom-blue-600 to-indigo-600 rounded-2xl shadow-xl p-8 mb-8 text-white">
          ...
          <ul className="space-y-3 text-lg">
            <li className="flex items-start">
              ...
              <span>
                University exam schedules will be announced as per HNBUMU
                calendar
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-2xl mr-3">📌</span>
              <span>
                Festival dates may vary based on lunar calendar and will be
            ...
            <li className="flex items-start">
              <span className="text-2xl mr-3">📌</span>
              <span>
                Additional holidays may be declared by the government and will
            ...
            <li className="flex items-start">
              <span className="text-2xl mr-3">📌</span>
              <span>
                Students should check the notice board regularly for any changes
                or updates
              </span>
            </li>
          </ul>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Get a printable version of the complete holiday calendar
          </p>
          <button
