...
export default function Academics() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 mt-0">
      {/* Hero Section */}
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            At Garhwal Institute of Paramedical Sciences (GIPS), academics are
            built around innovation, mentorship, and practical exposure. We
            strive to equip students with knowledge, skills, and values that
            empower them to excel in their chosen careers.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {academicSections.map((section, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`${section.color} p-6 flex justify-center items-center h-24`}
                  >
        ...
        {/* Key Highlights */}
        <div className="bg-linear-to-rfrom-indigo-500 to-purple-600 rounded-lg shadow-lg p-8 text-white">
          <h2 className="text-3xl font-bold mb-6">
            Why Choose GIPS Academics?
          </h2>
