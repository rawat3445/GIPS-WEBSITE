...
export default function StudentSupport() {
  ...
  const supportServices = [
    {
      ...
      description:
        "Professional counseling support for all your academic and personal concerns",
      color: "from-blue-500 to-blue-600",
      bgColor: "bg-blue-50",
      details: {
        overview:
          "Our counseling services provide comprehensive support to help students navigate academic challenges, career decisions, and personal issues.",
        services: [
    ...
    },
    {
      ...
      description:
        "Access to healthcare facilities and comprehensive wellness programs",
      color: "from-red-500 to-pink-600",
      bgColor: "bg-red-50",
      details: {
        overview:
          "We prioritize student health with on-campus medical facilities and regular wellness initiatives.",
        services: [
    ...
    },
    {
      ...
      description:
        "Scholarships, fee waivers, and financial assistance programs",
      color: "from-green-500 to-emerald-600",
      bgColor: "bg-green-50",
      details: {
        overview:
          "We believe financial constraints should never hinder education. Multiple aid options are available.",
        services: [
    ...
    },
    {
      ...
      details: {
        overview:
          "Our placement cell works tirelessly to bridge the gap between education and employment.",
        services: [
    ...
    },
    {
      ...
      description:
        "Zero tolerance policy with strict monitoring and safety measures",
      color: "from-orange-500 to-red-600",
      bgColor: "bg-orange-50",
      details: {
        overview:
          "GIPS maintains a completely safe and ragging-free environment for all students.",
        services: [
    ...
    },
    {
      ...
      description:
        "Extra support for academic excellence and learning enhancement",
      color: "from-cyan-500 to-blue-600",
      bgColor: "bg-cyan-50",
      details: {
        overview:
          "Additional academic support to help every student achieve their full potential.",
        services: [
  ...
  const quickHelp = [
    ...
    },
    {
      ...
      value: "garhwalparamedicalinstitute@gmail.com",
      color: "text-blue-600",
    },
    {
      icon: MessageCircle,
  ...
  const faqs = [
    {
      ...
      answer:
        "You can book an appointment through the student portal or visit the counseling center directly during office hours. All sessions are confidential.",
    },
    {
      question: "What scholarships are available?",
      answer:
        "We offer merit-based scholarships, need-based financial aid, and help with government scholarships. Visit the financial aid office for detailed information.",
    },
    {
      question: "How does the placement process work?",
      answer:
        "Students are registered with the placement cell in their final year. We conduct pre-placement training, invite recruiters, and facilitate interviews on campus.",
    },
    {
      question: "What should I do in case of a medical emergency?",
      answer:
        "Contact the emergency helpline immediately. Our medical team and nearby hospital partners provide 24/7 emergency support.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      message:
        "The counseling services helped me overcome my exam anxiety. The support staff is incredibly caring and understanding.",
    },
    {
      name: "Arjun Singh",
      course: "BMRIT 3rd Year",
      message:
        "Got placed in a leading hospital through campus recruitment. The placement cell's training and support was invaluable!",
    },
    {
      name: "Priya Sharma",
      course: "B.Optom 2nd Year",
      message:
        "The scholarship I received made my education possible. Forever grateful to GIPS for their financial support.",
    },
  ];
      ...
      <div className="bg-linear-to-rfrom-blue-600 via-purple-600 to-pink-600 text-white px-8 py-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
            We&apos;re here for you every step of the way - providing
            comprehensive support for your academic, personal, and professional
            journey
          </p>
          <button
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-purple-600">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            GIPS offers a wide range of student support services to ensure a
            safe, enriching, and supportive academic environment. We understand
            that student life encompasses more than just academics, which is why
            we provide comprehensive support across all aspects of your college
            experience.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed">
            Our dedicated team of professionals is committed to your success,
            wellbeing, and personal growth. Whether you need academic guidance,
            financial assistance, career counseling, or just someone to talk to
            - we&apos;re here for you.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {supportServices.map((service) => {
              ...
              return (
                ...
                >
                  <div
                    className={`bg-linear-to-r${service.color} p-6 text-white`}
                  >
              ...
              return (
                <>
                  <div className="flex items-center mb-6">
                    <div
                      className={`bg-linear-to-r${service.color} w-16 h-16 rounded-full flex items-center justify-center text-white mr-4`}
                    >
                      <IconComponent className="w-8 h-8" />
                    </div>
                    <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 bg-linear-to-rfrom-purple-50 to-pink-50 rounded-xl p-6">
                    <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {quickHelp.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className=" bg-opacity-20 backdrop-blur-sm rounded-xl p-6 hover:bg-opacity-30 transition-all text-center"
                >
        ...
        {/* Call to Action */}
        <div className="bg-linear-to-rfrom-blue-600 via-purple-600 to-pink-600 rounded-2xl shadow-2xl p-12 text-white text-center">
          ...
          <p className="text-xl mb-8 text-purple-100 max-w-3xl mx-auto">
            ...
            ensuring you have the best possible experience at GIPS.
          </p>
