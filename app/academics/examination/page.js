...
export default function Examination() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Regular feedback to track student progress throughout semester",
      icon: BarChart,
    },
    {
    ...
    },
    {
      ...
      description:
        "External examiners and moderation for maintaining standards",
      icon: Award,
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">
            Our Examination Philosophy
          </h2>
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p className="text-lg">
              The examination system at GIPS is designed to comprehensively
              evaluate student learning, understanding, and practical skills. We
              follow a balanced approach that combines continuous assessment
              with end-semester examinations, ensuring that every student&apos;s
              progress is monitored and evaluated fairly throughout their
              academic journey.
            </p>
            <p className="text-lg">
              Our evaluation methodology focuses not just on theoretical
              knowledge but also on practical competencies, clinical skills, and
              professional aptitude. We believe in transparent, objective, and
              standardized assessment processes that prepare students for
          ...
          <div className="space-y-6">
            {examTypes.map((exam, index) => {
              ...
              return (
                ...
                >
                  <div className={`bg-linear-to-r${exam.color} p-6 text-white`}>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-linear-to-rfrom-blue-600 to-indigo-600 text-white">
        ...
        <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-8 mb-12">
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-white rounded-lg overflow-hidden shadow-md">
              <thead>
                <tr className="bg-linear-to-rfrom-indigo-600 to-purple-600 text-white">
                  <th className="px-6 py-4 text-center text-lg font-semibold">
                    Grade
                  </th>
                  <th className="px-6 py-4 text-center text-lg font-semibold">
              ...
              <tbody>
                {gradingSystem.map((grade, index) => (
                  ...
                  >
                    <td className="px-6 py-4 text-center font-bold text-xl text-indigo-600">
                      {grade.grade}
                    </td>
        ...
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-8">
            Examination Guidelines & Procedures
          </h2>
        ...
        {/* Important Notes */}
        <div className="bg-linear-to-rfrom-blue-600 to-indigo-600 rounded-lg shadow-lg p-8 text-white">
          ...
          <div className="space-y-4 text-blue-50">
            <div className="flex items-start">
              ...
              <p className="text-lg">
                Students must maintain academic integrity. Any form of
                malpractice or unfair means will result in strict disciplinary
                action.
              </p>
            </div>
            <div className="flex items-start">
              <AlertCircle className="w-6 h-6 mr-3 flex-shrink-0 mt-1" />
              <p className="text-lg">
                For detailed examination rules, schedule, and updates, students
                should regularly check the official notice board and student
                portal.
              </p>
            </div>
            <div className="flex items-start">
              <AlertCircle className="w-6 h-6 mr-3 flex-shrink-0 mt-1" />
              <p className="text-lg">
                Students facing any genuine difficulties regarding examinations
                should contact the examination cell or academic coordinator
                immediately.
              </p>
            </div>
          </div>
