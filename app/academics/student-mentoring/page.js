...
export default function StudentMentoring() {
  ...
  const testimonials = [
    {
      ...
      quote:
        "My mentor helped me overcome my fears and guided me through difficult subjects. Their support was instrumental in my academic success.",
    },
    {
      name: "Rahul Kumar",
      course: "BOTT 2nd Year",
      quote:
        "The career counseling sessions opened my eyes to various opportunities in the medical field. I'm now confident about my future.",
    },
    {
      name: "Anjali Verma",
      course: "B.Optom 3rd Year",
      quote:
        "The mental health support and stress management workshops helped me maintain balance during challenging times. Truly grateful!",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      {/* Hero Section */}
      <div className="bg-linear-to-rfrom-indigo-600 via-purple-600 to-pink-600 text-white px-8 py-20">
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-purple-600">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
            <p>
              GIPS strongly believes in nurturing every student through
              personalized mentoring programs. Faculty members act as academic
              and personal guides, ensuring that students can balance their
              academic journey with emotional and professional growth.
            </p>
            <p>
              We understand that each student is unique, with individual dreams,
              challenges, and potential. Our mentoring program is designed to
              provide holistic support that goes beyond textbooks, helping
              students develop into confident, well-rounded healthcare
              professionals.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          {stats.map((stat, index) => (
            ...
            >
              <div className="text-5xl font-bold bg-linear-to-rfrom-indigo-600 to-purple-600 bg-clip-text text-transparent mb-2">
                {stat.number}
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {mentoringPrograms.map((program, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`bg-linear-to-r${program.color} p-6 text-white`}
                  >
                  ...
                  <div
                    className={`p-6 transition-all duration-300 ${
                      isSelected ? "max-h-96" : "max-h-0 overflow-hidden"
                    }`}
                  >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mentorshipBenefits.map((benefit, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-6 hover:bg-opacity-30 transition-all"
                >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12">
          ...
          <p className="text-lg text-gray-700 text-center mb-8 max-w-3xl mx-auto">
            Our mentors are carefully selected faculty members who combine
            academic expertise with genuine care for student wellbeing and
            success.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {mentorQualities.map((quality, index) => (
              <div
                key={index}
                className="flex items-start bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-5 border-l-4 border-purple-600"
              >
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow border-t-4 border-purple-600"
              >
        ...
        {/* Call to Action */}
        <div className="bg-linear-to-rfrom-pink-600 via-purple-600 to-indigo-600 rounded-2xl shadow-2xl p-12 text-white text-center">
          <h2 className="text-4xl font-bold mb-4">Need Guidance?</h2>
          <p className="text-xl mb-8 text-purple-100">
            Our mentors are here to support you every step of the way.
