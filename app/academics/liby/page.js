...
export default function Libraries() {
  ...
  const collections = [
    {
      ...
      count: "5,000+",
      description:
        "Comprehensive collection covering all paramedical disciplines",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-50 mt-0">
      <div className="bg-linear-to-rfrom-indigo-600 to-purple-700 text-white px-8 py-16">
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">
            Welcome to GIPS Library
          </h2>
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p className="text-lg">
              The library at GIPS is a comprehensive knowledge hub designed to
              support learning, teaching, and research activities across all
              programs. With a vast collection of books, journals, research
              papers, and e-resources, our library serves as the intellectual
              heart of the institution.
            </p>
            <p className="text-lg">
              We provide a conducive learning environment with modern
              facilities, digital resources, and expert assistance to help
              students and faculty excel in their academic pursuits. Our library
              is not just a repository of books, but a dynamic learning space
              that fosters curiosity, creativity, and academic excellence.
            </p>
          </div>
        </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {facilities.map((facility, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="border-2 border-gray-200 rounded-lg p-6 hover:border-indigo-500 transition-all hover:shadow-lg"
                      >
                        <div
                          className={`bg-linear-to-r${facility.color} w-16 h-16 rounded-lg flex items-center justify-center mb-4`}
                        >
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  {collections.map((collection, index) => (
                    <div
                      key={index}
                      className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-6 border-l-4 border-indigo-600"
                    >
                ...
                <div className="bg-linear-to-rfrom-purple-600 to-indigo-600 rounded-lg p-6 text-white">
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    {digitalResources.map((resource, index) => (
                      <div
                        key={index}
                        className="flex items-center bg-blue-500 bg-opacity-20 rounded-lg px-4 py-3"
                      >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {services.map((service, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="border-2 border-gray-200 rounded-lg p-6 hover:border-purple-500 transition-all"
                      >
                        <div className="flex items-center mb-4">
                ...
                <div className="mb-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {timings.map((timing, index) => (
                      <div
                        key={index}
                        className="flex justify-between items-center bg-linear-to-rfrom-indigo-50 to-purple-50 rounded-lg p-6 border-l-4 border-indigo-600"
                      >
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {rules.map((rule, index) => (
                      <div
                        key={index}
                        className="flex items-start bg-white border-2 border-gray-200 rounded-lg p-4 hover:border-indigo-500 transition-colors"
                      >
        ...
        <div className="bg-linear-to-rfrom-indigo-600 to-purple-600 rounded-lg shadow-lg p-8 mb-12 text-white">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <p className="text-lg text-gray-700 mb-4">
            Our librarians are always ready to help you find the resources you
            need and guide you in your research activities.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            <div className="flex items-center bg-purple-50 rounded-lg px-6 py-3">
              ...
              <span className="text-gray-700">
                Contact reference section for research help
              </span>
            </div>
          </div>
        </div>
