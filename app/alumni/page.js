...
export default function AlumniPage() {
  ...
  const featuredAlumni = [
    {
      ...
      location: "Delhi",
      achievement:
        "Leading the rehabilitation department with innovative techniques",
    ...
    },
    {
      ...
      location: "Mumbai",
      achievement:
        "Implemented advanced imaging protocols, improved diagnostic accuracy",
      image: "/api/placeholder/200/200",
    },
    {
      id: 3,
      ...
      location: "Dehradun",
      achievement:
        "Successfully running own optometry clinic serving 500+ patients",
      image: "/api/placeholder/200/200",
    },
    {
      id: 4,
      ...
      location: "Gurgaon",
      achievement:
        "Managing 12 operation theatres, trained 50+ junior technicians",
      image: "/api/placeholder/200/200",
    },
    {
      id: 5,
  ...
  const successStories = [
    {
      ...
      description:
        "Placeholder for success story - Alumni who started their own diagnostic center after graduating from GIPS. Now employing 20+ staff and serving the community.",
    ...
    },
    {
      ...
      description:
        "Placeholder for international success - GIPS alumnus working in renowned hospital abroad, representing Indian paramedical excellence on global stage.",
      image: "/api/placeholder/400/250",
    },
    {
      ...
      description:
        "Placeholder for research story - Alumni pursuing PhD, published papers in international journals, contributing to medical research advancements.",
      image: "/api/placeholder/400/250",
    },
  ];
  ...
  const alumniTestimonials = [
    {
      quote:
        "GIPS gave me the foundation, skills, and confidence to build a successful career. The practical training and faculty mentorship were invaluable in shaping my professional journey.",
    ...
    {
      quote:
        "The education I received at GIPS was world-class. The combination of theoretical knowledge and hands-on experience prepared me perfectly for the challenges of the healthcare industry.",
    ...
    {
      quote:
        "GIPS is not just an institute, it's a family. The connections, friendships, and professional network I built here continue to benefit my career even today.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-emerald-50 to-cyan-50 mt-0">
      ...
      <div className="bg-linear-to-rfrom-teal-600 via-emerald-600 to-cyan-600 text-white px-8 py-20">
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {alumniStats.map((stat, index) => {
              ...
              return (
                <div
                  key={index}
                  className="text-center bg-gradient-to-br from-teal-50 to-emerald-50 rounded-xl p-6 hover:shadow-lg transition-all"
                >
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className={`px-6 py-3 rounded-lg font-semibold transition-all ${
                activeTab === "featured"
                  ? "bg-linear-to-rfrom-teal-600 to-emerald-600 text-white shadow-lg"
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-teal-600">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Meet our accomplished alumni who are making significant
                contributions to healthcare across various specializations and
                organizations. Their success stories inspire current students
                and showcase the quality of education at GIPS.
              </p>
            </div>
        ...
        {activeTab === "stories" && (
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-emerald-600">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Inspiring journeys of GIPS alumni who have achieved remarkable
                success in their careers. From starting their own ventures to
                working with prestigious organizations, our alumni are making us
                proud every day.
              </p>
            </div>
            ...
            <div className="bg-linear-to-rfrom-teal-50 to-emerald-50 border-2 border-dashed border-teal-300 rounded-2xl p-12 text-center mt-8">
              <Target className="w-16 h-16 text-teal-600 mx-auto mb-4" />
              <h3 className="text-2xl font-bold text-gray-800 mb-2">
                More Stories Coming Soon
              </h3>
              <p className="text-gray-600">
                We&apos;re collecting more inspiring success stories from our
                alumni network
              </p>
            </div>
          </div>
        ...
        {activeTab === "testimonials" && (
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-cyan-600">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Hear directly from our alumni about their experiences at GIPS
                and how it shaped their professional careers. Their words
                reflect the quality of education and life-long impact of being
                part of the GIPS family.
              </p>
            </div>
        ...
        {activeTab === "batchwise" && (
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-emerald-600">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Our alumni network spans across multiple batches, each
                contributing uniquely to the healthcare sector. Explore alumni
                information organized by graduation year.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {alumniByYear.map((batch, index) => (
                <div
                  key={index}
                  className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all border-l-4 border-teal-600"
                >
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-4xl font-bold text-gray-800">
                      Batch of {batch.year}
                    </h3>
                    <span className="bg-linear-to-rfrom-teal-600 to-emerald-600 text-white px-6 py-2 rounded-full text-2xl font-bold">
                      {batch.count}
                    </span>
                  </div>
        ...
        {/* Alumni Network CTA */}
        <div className="bg-linear-to-rfrom-teal-600 via-emerald-600 to-cyan-600 rounded-2xl shadow-xl p-12 mt-0 text-white text-center">
          ...
          <p className="text-xl mb-8 text-teal-100 max-w-3xl mx-auto">
            Join our alumni network, share your success story, mentor current
            students, and stay connected with your alma mater. Together we grow
            stronger!
          </p>
