...
export default function ResearchOverview() {
  ...
  const researchCells = [
    ...
    },
    {
      ...
      description:
        "The Startups & Innovation Cell at GIPS cultivates an entrepreneurial mindset among students and faculty by providing a supportive ecosystem for innovation and venture creation in healthcare technology. The cell offers mentorship, funding support, incubation facilities, and networking opportunities to transform innovative ideas into successful healthcare startups. It bridges the gap between academic research and commercial applications, encouraging students to become job creators rather than job seekers.",
      keyFunctions: [
    ...
    },
    {
      ...
      description:
        "The Student Research Cell at GIPS is a student-driven initiative that encourages undergraduate and postgraduate students to actively engage in research activities. It provides a platform for students to develop research skills, present their work, and contribute to scientific knowledge in paramedical sciences. The cell organizes research competitions, facilitates peer learning, and helps students publish their research findings, preparing them for advanced academic pursuits and research careers.",
      keyFunctions: [
  ...
  const whyResearch = [
    {
      ...
      description:
        "Develop analytical and problem-solving skills through research",
    },
    {
      icon: Target,
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-5xl mx-auto">
            {researchImpact.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white/5 backdrop-blur-md rounded-xl p-6 border border-white/30"
                >
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-blue-600">
          <h2 className="text-4xl font-bold text-gray-800 mb-6">
            Research Excellence at GIPS
          </h2>
          <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
            <p>
              At Garhwal Institute of Paramedical Sciences, research is the
              foundation of academic excellence and innovation. We believe that
              quality research not only advances scientific knowledge but also
              improves patient care, healthcare delivery, and contributes to
              solving real-world medical challenges.
            </p>
            <p>
              Our research ecosystem comprises six specialized cells, each
              dedicated to fostering innovation, protecting intellectual
              property, nurturing excellence, promoting entrepreneurship,
              empowering student researchers, and establishing centers of
              specialized expertise. These cells work collaboratively to create
              a vibrant research culture that encourages curiosity, creativity,
              and cutting-edge discoveries.
            </p>
            <p>
              From fundamental research in physiotherapy and medical imaging to
              applied research in healthcare technology and startups, GIPS
              provides comprehensive support for faculty and students to engage
              in meaningful research that makes a difference in the medical
              community.
            </p>
          </div>
        </div>
              ...
              return (
                ...
                >
                  <div
                    ...
                    className={`bg-linear-to-r${cell.color} p-8 text-white cursor-pointer hover:opacity-95 transition-opacity`}
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-3xl">{isSelected ? "−" : "+"}</div>
                    </div>
                  </div>
                  ...
                  {isSelected && (
                    <div className="p-8 bg-gradient-to-br from-gray-50 to-white">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-3">
                          {cell.keyFunctions.map((func, idx) => (
                            <div
                              key={idx}
                              className="flex items-start bg-white rounded-lg p-4 shadow-sm border-l-4 border-blue-500"
                            >
                      ...
                      {/* Achievements */}
                      <div className="bg-linear-to-rfrom-yellow-50 to-orange-50 rounded-xl p-6 border-l-4 border-orange-500">
        ...
        <div className="bg-linear-to-rfrom-indigo-600 to-purple-600 rounded-2xl shadow-xl p-10 mb-12 text-white">
          ...
          <p className="text-xl text-center mb-8 text-indigo-100">
            GIPS collaborates with leading institutions to enhance research
            quality and impact
          </p>
              ...
              <div className="space-y-3">
                <div className="flex items-start bg-blue-50 rounded-lg p-4">
                  ...
                  <span className="text-gray-700">
                    Seed funding up to ₹5 lakhs per project
                  </span>
                </div>
                <div className="flex items-start bg-blue-50 rounded-lg p-4">
                  <span className="text-blue-600 mr-3">•</span>
                  <span className="text-gray-700">
                    Publication support and assistance
                  </span>
                </div>
                <div className="flex items-start bg-blue-50 rounded-lg p-4">
                  <span className="text-blue-600 mr-3">•</span>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start bg-purple-50 rounded-lg p-4">
                  <span className="text-purple-600 mr-3">•</span>
                  <span className="text-gray-700">
                    Funding for innovative project ideas
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-12 text-center border-t-4 border-blue-600">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Whether you&apos;re a faculty member with a groundbreaking idea or a
            student eager to explore research, GIPS provides the perfect
            ecosystem to turn your vision into reality.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-linear-to-rfrom-blue-600 to-purple-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-xl transition-all transform hover:scale-105">
