      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white shadow-xl rounded-3xl p-8 mb-8">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            The Bachelor of Physiotherapy (BPT) is a four-year undergraduate
            program that focuses on the science of physical movement and the
            prevention, diagnosis, and treatment of physical disabilities and
            injuries. This course equips students with the knowledge and
            practical skills required to help individuals restore mobility,
            reduce pain, and improve overall physical function through
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-xl rounded-2xl p-8">
            ...
            <div className="space-y-6">
              <div className="bg-green-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="w-2 h-2 bg-green-600 rounded-full mt-0 flex-shrink-0"></span>
                    <span>
                      <strong>Eligibility:</strong> 10+2 (Science Stream – PCB)
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>
                    • Comprehensive training in anatomy, physiology,
                    biomechanics, exercise therapy, and electrotherapy
                  </li>
                  <li>
                    • Hands-on clinical experience through internships in
                    hospitals, rehabilitation centers, and physiotherapy clinics
                  </li>
                  <li>
                    • Exposure to sports physiotherapy, neurological
                    rehabilitation, orthopedics, and cardiopulmonary
                    physiotherapy
                  </li>
                  <li>
                    • Focus on manual therapy, posture correction, and
          ...
          <div className="bg-white shadow-xl rounded-2xl p-8">
            ...
            <div className="space-y-6">
              <div className="bg-linear-to-rfrom-blue-50 to-green-50 p-6 rounded-lg">
              ...
              <div className="bg-indigo-50 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-700">
                  Various positions available in government hospitals, AIIMS,
                  PGI, Railway hospitals, and Armed Forces medical services.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white shadow-xl rounded-2xl p-8 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl">
              ...
              <div className="space-y-3">
                <p className="text-gray-700">
                  India physiotherapy market size was valued at $0.96 billion in
                  2022 and is estimated to expand at a CAGR of 8.85% from 2022
                  to 2030 and will reach $1.9 billion in 2030.
                </p>
                <p className="text-gray-700">
                  The physiotherapy equipment market in India is expected to
                  reach a projected revenue of US$ 1,673.5 million by 2030 with
                  a compound annual growth rate of 9% from 2024 to 2030.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl">
              ...
              <div className="space-y-3">
                <p className="text-gray-700">
                  Key factors driving growth include an expanding geriatric
                  population, increasing prevalence of cardiovascular diseases,
                  and rising awareness of physiotherapy.
                </p>
                <p className="text-gray-700">
                  Growing demand for rehabilitation services and preventive
                  healthcare creating numerous career opportunities.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-purple-50 p-4 rounded-lg text-center">
              ...
              <p className="text-2xl font-bold text-purple-600 mt-0">
                ₹20K-₹1L+
              </p>
              <p className="text-sm text-gray-600">
                Entry-level: ₹20,000-₹35,000, Experienced: ₹60,000-₹1,00,000+
              </p>
            </div>
            <div className="bg-orange-50 p-4 rounded-lg text-center">
              ...
              <p className="text-sm text-gray-600">
                Government, Private, Self-practice options
              </p>
            </div>
        ...
        <div className="bg-white shadow-xl rounded-2xl p-8 mt-8">
          ...
          <div className="mt-6 bg-linear-to-rfrom-green-100 to-blue-100 p-6 rounded-xl">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">
              Clinical Training & Internship
            </h3>
            <p className="text-gray-700 leading-relaxed">
              The 6-month mandatory internship provides hands-on experience in
              various clinical settings including hospitals, rehabilitation
              centers, sports clinics, and community health centers. Students
              gain practical skills in patient assessment, treatment planning,
              therapeutic interventions, and professional patient care.
            </p>
          </div>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Growing healthcare sector ensures excellent job prospects
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Help people recover and improve their quality of life
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Multiple specializations and work environments available
                  </p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Indian BPT degree recognized internationally
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Opportunity to start your own physiotherapy clinic
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Rapidly evolving field with new techniques and technologies
                  </p>
                </div>
              </div>
            </div>
