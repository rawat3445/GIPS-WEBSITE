      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white shadow-xl rounded-3xl p-8 mb-8">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            The Diploma in Optometry is a specialized program designed to
            provide students with essential knowledge and practical skills in
            vision care, eye examination techniques, and management of
            refractive errors. This program offers a strong foundation in
            optometry, preparing students to work as competent vision
            consultants and optometric assistants in the healthcare industry.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-sky-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="w-2 h-2 bg-sky-600 rounded-full mt-0 flex-shrink-0"></span>
                    <span>
                      <strong>Eligibility:</strong> 10+2 from any recognized
                      board
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-2 h-2 bg-sky-600 rounded-full mt-0 flex-shrink-0"></span>
                    <span>
                      <strong>Age Limit:</strong> No specific age restriction
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="bg-white shadow-xl rounded-2xl p-8">
            ...
            <div className="space-y-6">
              <div className="bg-linear-to-rfrom-blue-50 to-sky-50 p-6 rounded-lg">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="bg-white p-3 rounded-lg shadow-sm">
                    ...
                    <span className="text-sm text-gray-600 block">
                      optical retail chains and clinics
                    </span>
                  </div>
                  <div className="bg-white p-3 rounded-lg shadow-sm">
              ...
              <div className="bg-indigo-50 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-700">
                  Graduates can pursue advanced certifications, specialize in
                  contact lens fitting, or progress to supervisory roles in
        ...
        <div className="bg-white shadow-xl rounded-2xl p-8 mt-8">
          ...
          <div className="mt-6 bg-linear-to-rfrom-sky-100 to-blue-100 p-6 rounded-xl">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">
              Practical Training
            </h3>
            <p className="text-gray-700 leading-relaxed">
              Students gain hands-on experience in optical laboratories, vision
              care centers, and retail optical outlets. The program emphasizes
              practical skills development through real-world training
              scenarios, ensuring graduates are job-ready upon completion.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white shadow-xl rounded-2xl p-8 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-sky-50 to-blue-50 p-6 rounded-xl">
              ...
              <div className="space-y-3">
                <p className="text-gray-700">
                  The demand for optometrists is increasing due to factors such
                  as rising screen time, an aging population, & growing
                  awareness about eye care
                </p>
                <p className="text-gray-700">
                  The rise in digital device usage has significantly increased
                  vision-related problems, creating more job opportunities for
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl">
              ...
              <div className="space-y-3">
                <p className="text-gray-700">
                  The Diploma in Optometry scope for a successful career is
                  quite vast for fresh graduates in both the public and the
                  private sector.
                </p>
                <p className="text-gray-700">
                  Graduates can work as vision consultants, customer care
                  associates, and progress to management roles in optical
                  chains.
                </p>
              </div>
            </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-orange-50 p-4 rounded-lg text-center">
              ...
              <p className="text-lg font-bold text-orange-600 mt-0">
                Expanding
              </p>
        ...
        <div className="bg-white shadow-xl rounded-2xl p-8 mt-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-6">
            Diploma vs Bachelor in Optometry
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-sky-50 p-6 rounded-xl border-l-4 border-sky-500">
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li>
                  • <strong>Focus:</strong> Practical skills and immediate job
                  readiness
                </li>
                <li>
                  • <strong>Entry:</strong> 10+2 any stream
                </li>
                <li>
                  • <strong>Career:</strong> Technician and assistant roles
                </li>
                <li>
                  • <strong>Investment:</strong> Lower cost, faster entry to
                  workforce
                </li>
              </ul>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
              ...
              <ul className="space-y-2 text-gray-700">
                <li>
                  • <strong>Duration:</strong> 4 years (3+1 internship)
                </li>
                <li>
                  • <strong>Focus:</strong> Comprehensive theoretical and
                  clinical training
                </li>
                <li>
                  • <strong>Entry:</strong> 10+2 Science (PCB/PCM)
                </li>
                <li>
                  • <strong>Career:</strong> Independent practice and specialist
                  roles
                </li>
                <li>
                  • <strong>Investment:</strong> Higher cost, advanced career
                  opportunities
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Practical-focused training aligned with current industry
                    needs
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Well-equipped laboratories and clinical training areas
                  </p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Strong industry connections for job placement support
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Quality education at competitive fees structure
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    2-year program for faster career start
                  </p>
                </div>
              </div>
            </div>
