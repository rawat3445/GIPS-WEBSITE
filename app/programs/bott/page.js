      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white shadow-xl rounded-3xl p-8 mb-8">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            The Bachelor in Operation Theater Technology (BOTT) is a specialized
            undergraduate program designed to equip students with the knowledge
            and skills required to assist in surgical procedures and manage
            operation theater (OT) activities efficiently. This program prepares
            students to work as vital members of the surgical team, ensuring
            smooth functioning and maintenance of operating rooms in hospitals
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-xl rounded-2xl p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>
                    • Comprehensive training in operation theater management,
                    surgical instrumentation, anesthesia technology, and
                    infection control
                  </li>
                  <li>
                    • Hands-on experience through clinical training and
                    internships in reputed hospitals
                  </li>
                  <li>
                    • Exposure to advanced surgical technologies and emergency
                    procedures
                  </li>
                  <li>
                    • Experienced faculty, well-equipped simulation labs, and
                    real-time surgical environment training
                  </li>
                </ul>
              </div>
          ...
          <div className="bg-white shadow-xl rounded-2xl p-8">
            ...
            <div className="space-y-6">
              <div className="bg-linear-to-rfrom-blue-50 to-teal-50 p-6 rounded-lg">
        ...
        <div className="bg-white shadow-xl rounded-2xl p-8 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-teal-50 to-blue-50 p-6 rounded-xl">
              ...
              <div className="space-y-3">
                <p className="text-gray-700">
                  India healthcare sector expected to reach Rs. 4,11,275 crore
                  (US$ 47,806.9 million) by 2033, at a CAGR of 17.67%
                </p>
                <p className="text-gray-700">
                  Private equity and venture capital investments surpassing US$
                  1 billion in the first five months of FY24, marking a 220%
                  increase
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl">
              ...
              <div className="space-y-3">
                <p className="text-gray-700">
                  Global operating room equipment market valued at US$ 37.3
                  billion in 2022, expected to reach US$ 59.5 billion by 2032
                </p>
                <p className="text-gray-700">
                  India Operating Tables Market valued at USD 26.78 million in
                  2024, anticipated to reach USD 38.83 million by 2030 (6.25%
                  CAGR)
                </p>
              </div>
            </div>
        ...
        <div className="bg-white shadow-xl rounded-2xl p-8 mt-8">
          ...
          <div className="mt-6 bg-linear-to-rfrom-teal-100 to-blue-100 p-6 rounded-xl">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">
              Clinical Training & Internship
            </h3>
            <p className="text-gray-700 leading-relaxed">
              The one-year mandatory internship provides extensive hands-on
              experience in various surgical departments. Students work directly
              in operating theaters, learning to handle surgical instruments,
              maintain sterile environments, assist surgeons, and manage OT
              logistics under expert supervision.
            </p>
          </div>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Specialized equipment for heart surgeries
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Brain and nervous system surgical support
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Bone and joint surgery assistance
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Essential member of surgical teams
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Work with advanced surgical technology
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Always in demand in healthcare sector
                  </p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Multiple surgical specialties to choose from
                  </p>
                </div>
              </div>
            </div>
