...
export default function CareerPage() {
  ...
  const careerPaths = [
      ...
      careers: [
        {
          ...
          sector: "Hospitals, Clinics, Rehabilitation Centers",
        },
        {
          role: "Sports Physiotherapist",
          sector: "Sports Teams, Fitness Centers, Sports Academies",
        },
        {
          role: "Occupational Therapist",
          sector: "Hospitals, Schools, Community Health",
        },
        {
          role: "Clinical Specialist",
          sector: "Specialty Hospitals, ICU, Neurology Departments",
        },
        {
          role: "Rehabilitation Specialist",
          sector: "Rehab Centers, Elderly Care Homes",
        },
        {
          role: "Healthcare Consultant",
          sector: "Private Practice, Corporate Wellness Programs",
        },
      ],
    ...
    },
    {
      ...
      careers: [
        {
          role: "Radiographer",
          sector: "Hospitals, Diagnostic Centers, Imaging Labs",
        },
        {
          role: "MRI Technician",
          sector: "Multi-specialty Hospitals, Imaging Centers",
        },
        {
          role: "CT Scan Technician",
          sector: "Hospitals, Trauma Centers, Research Labs",
        },
        {
          role: "X-Ray Technician",
          sector: "Clinics, Hospitals, Health Checkup Centers",
        },
        {
          role: "Ultrasound Technician",
          sector: "Maternity Hospitals, Diagnostic Centers",
        },
        {
          role: "Radiology Supervisor",
          sector: "Hospital Radiology Departments",
        },
      ],
    ...
    },
    {
      ...
      careers: [
        {
          role: "OT Technician",
          sector: "Multi-specialty Hospitals, Surgical Centers",
        },
        {
          role: "Surgical Assistant",
          sector: "Operation Theatres, Emergency Departments",
        },
        {
          role: "Anesthesia Technician",
          sector: "Hospitals, Day Care Surgery Centers",
        },
        {
          role: "Sterilization In-charge",
          sector: "Hospitals, CSSD Departments",
        },
        {
          role: "OT Coordinator",
          sector: "Hospital Administration, OT Management",
        },
        {
          role: "Medical Equipment Specialist",
          sector: "Medical Device Companies, Hospitals",
        },
      ],
    ...
    },
    {
      ...
      careers: [
        {
          role: "Optometrist",
          sector: "Eye Hospitals, Optical Stores, Vision Centers",
        },
        {
          role: "Clinical Optometrist",
          sector: "Specialty Eye Hospitals, Eye Clinics",
        },
        {
          role: "Contact Lens Specialist",
          sector: "Optical Retail Chains, Eye Care Centers",
        },
        {
          role: "Vision Therapist",
          sector: "Pediatric Eye Clinics, Vision Therapy Centers",
        },
        {
          role: "Low Vision Specialist",
          sector: "NGOs, Disability Centers, Eye Hospitals",
        },
        {
          role: "Optical Store Manager",
          sector: "Retail Optical Chains, Private Practice",
        },
      ],
  ...
  const topRecruiters = [
    ...
    {
      name: "Government Medical Colleges & Hospitals",
      sector: "Government Sector",
    },
    { name: "District Hospitals", sector: "Government Healthcare" },
    {
      name: "Diagnostic Centers (SRL, Dr. Lal PathLabs, Thyrocare)",
      sector: "Diagnostics",
    },
  ];
  ...
  const placementProcess = [
    ...
    },
    {
      ...
      description:
        "Resume preparation, LinkedIn profile, portfolio development",
      icon: BookOpen,
    },
    {
      step: 3,
      ...
      description:
        "Soft skills, interview techniques, aptitude tests, mock interviews",
      icon: Target,
    },
    {
      step: 4,
    ...
    },
    {
      ...
      title: "Job Offers",
      description:
        "Selected candidates receive offer letters and joining details",
      icon: Award,
    },
    {
      step: 6,
      ...
      description:
        "Guidance for job joining, career counseling, alumni network",
      icon: Users,
    },
  ];
  ...
  const careerSupport = [
    {
      ...
      description:
        "Professional guidance on creating impactful resumes and cover letters",
      icon: BookOpen,
    },
    {
      service: "Mock Interviews",
      description:
        "Practice sessions with industry experts for interview preparation",
      icon: Users,
    },
    {
      service: "Personality Development",
      description:
        "Communication skills, body language, professional etiquette training",
      icon: Star,
    },
    {
      service: "Aptitude Training",
      description:
        "Logical reasoning, quantitative ability, and verbal skills enhancement",
      icon: Target,
    },
    {
      service: "Industry Interaction",
      description:
        "Guest lectures, seminars, and workshops by healthcare professionals",
      icon: Globe,
    },
    {
  ...
  const higherStudies = [
    {
      ...
      description:
        "Specialized master's programs for advanced knowledge and better career prospects",
    },
    {
      option: "Research & PhD",
      courses: [
    ...
    },
    {
      ...
      courses: [
        "MS/PhD in USA, UK, Australia, Canada",
        "Clinical fellowships abroad",
      ],
      ...
      <div className="bg-linear-to-rfrom-blue-600 via-purple-600 to-pink-600 text-white px-8 py-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
            Building Successful Careers in Healthcare - From Campus to Career
            Excellence
          </p>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {placementStats.map((stat, index) => {
              ...
              return (
                <div
                  key={index}
                  className="text-center bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 hover:shadow-lg transition-all"
                >
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-blue-600">
              <h2 className="text-4xl font-bold text-gray-800 mb-6">
                Career Paths by Course
              </h2>
              <p className="text-lg text-gray-700 leading-relaxed">
                GIPS graduates have diverse career opportunities in hospitals,
                diagnostic centers, clinics, research institutions, and
                healthcare organizations. Here&apos;s a detailed overview of
                career paths available after completing each program:
              </p>
            </div>
            ...
            <div className="space-y-8">
              {careerPaths.map((path, index) => (
                ...
                >
                  <div className={`bg-linear-to-r${path.color} p-8 text-white`}>
                  ...
                  <div className="p-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {path.careers.map((career, idx) => (
                        <div
                          key={idx}
                          className="bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-lg p-5 hover:border-blue-500 transition-all"
                        >
            ...
            {/* Top Recruiters */}
            <div className="bg-linear-to-rfrom-green-600 to-teal-600 rounded-2xl shadow-xl p-10 mt-0 text-white">
        ...
        {activeTab === "placement" && (
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-purple-600">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                GIPS has a dedicated Placement Cell that works year-round to
                ensure maximum placement opportunities for students. Our
                systematic approach prepares students for successful careers
                from day one.
              </p>
            </div>
            ...
            <div className="space-y-6">
              {placementProcess.map((process, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex items-start bg-white rounded-2xl shadow-xl p-8"
                  >
        ...
        {activeTab === "support" && (
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-orange-600">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Our Placement Cell provides comprehensive career support
                services to ensure students are industry-ready and confident in
        ...
        {activeTab === "higher" && (
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-green-600">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Many GIPS graduates choose to pursue higher studies to
                specialize in their field and enhance their career prospects. We
                provide guidance and support for students aspiring for advanced
                degrees.
              </p>
            </div>
                ...
                <div key={index} className="bg-white rounded-2xl shadow-xl p-8">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {option.courses.map((course, idx) => (
                      <span
                        key={idx}
                        className="bg-green-50 text-green-700 px-4 py-2 rounded-full border border-green-300 text-sm font-semibold"
                      >
                        {course}
                      </span>
                    ))}
            ...
            {/* Entrepreneurship */}
            <div className="bg-linear-to-rfrom-indigo-600 to-purple-600 rounded-2xl shadow-xl p-10 text-white">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {entrepreneurship.map((option, index) => (
                  <div
                    key={index}
                    className="bg-white/20 backdrop-blur-md rounded-xl p-5 flex items-center border border-white/30"
                  >
